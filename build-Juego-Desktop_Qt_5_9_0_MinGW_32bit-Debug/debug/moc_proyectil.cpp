...
const QMetaObject Proyectil::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Proyectil.data,
      qt_meta_data_Proyectil,  qt_static_metacall, nullptr, nullptr}
};
...
void *Proyectil::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Proyectil.stringdata0))
        return static_cast<void*>(const_cast< Proyectil*>(this));
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Proyectil*>(this));
